...
namespace CK.MQTT
{
    public sealed class LifecyclePacketV5 : SimpleOutgoingPacket, IOutgoingPacket
    {
        ...
        public LifecyclePacketV5( int packetId, byte header, ReasonCode reason, string reasonString, bool isRemoteOwnedPacketId, IReadOnlyList<UserProperty>? userProperties )
        {
            PacketId = packetId;
            _header = header;
            _reason = reason;
