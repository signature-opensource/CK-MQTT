...
namespace CK.MQTT.Packets
{
    public class AwaitableOutgoingPacketWrapper : IOutgoingPacket
    {
        ...
        public AwaitableOutgoingPacketWrapper( IOutgoingPacket outgoingPacket ) => _outgoingPacket = outgoingPacket;

        public Task Sent => _taskCompletionSource.Task;

        public QualityOfService Qos => _outgoingPacket.Qos;
        public ushort PacketId { get => _outgoingPacket.PacketId; set => _outgoingPacket.PacketId = value; }
