...
namespace CK.MQTT.Client.Tests.Helpers
{
    static class MqttTestHelper
    {
        public static (PacketReplayer packetReplayer, IMqtt3Client client) CreateTestClient( Queue<TestPacket> packets )
        {
            ...
            IMqtt3Client client = MqttClientFactory.Factory.CreateMQTT3Client( TestConfigs.DefaultTestConfig( pcktReplayer ), ( IActivityMonitor m, DisposableApplicationMessage msg ) =>
            {
                msg.Dispose();
