...
using static CK.MQTT.Client.Tests.Helpers.SimpleTestMqtt3Client;
...
namespace CK.MQTT.Client.Tests.Helpers
{
    ...
    static class Scenario
    {
        ...
        public static async Task<(PacketReplayer packetReplayer, SimpleTestMqtt3Client client)> ConnectedClient( string channelType, IEnumerable<PacketReplayer.TestWorker> packets )
        {
        ...
        public static async Task<(PacketReplayer packetReplayer, SimpleTestMqtt3Client client)> ConnectedClient( string channelType,
        ...
        public static async Task RunOnConnectedClientWithKeepAlive( string channelType, IEnumerable<PacketReplayer.TestWorker> packets, DisconnectBehavior disconnectBehavior = DisconnectBehavior.Nothing )
        {
            ...
            SimpleTestMqtt3Client client = TestMqttClient.Factory.CreateMQTT3Client( TestConfigs.DefaultTestConfigWithKeepAlive( pcktReplayer, disconnectBehavior: disconnectBehavior ), ClientHelpers.NotListening_Dispose );
