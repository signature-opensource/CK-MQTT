...
namespace CK.MQTT.Server.Tests
{
    public class SmokeTests
    {
        ...
        public async Task client_send_message_server_receive_it()
        {
            ...
            res.serverClient.OnMessage.Sync += ( m, e ) =>
            {
                tcs.SetResult();
            };
            await res.client.PublishAsync( new SmallOutgoingApplicationMessage( "test", QualityOfService.AtMostOnce, false, Array.Empty<byte>() ) );
