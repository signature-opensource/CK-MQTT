...
namespace CK.MQTT.Client.Abstractions.Tests
{
    class TestImpl : IMqttClient
    {
        ...
        Task<ConnectResult> IMqttClient.ConnectAsync( IActivityMonitor m, MqttClientCredentials credentials, LastWill will, bool cleanSession )
        {
            throw new NotImplementedException();
        }

        Task<ConnectResult> IMqttClient.ConnectAnonymousAsync( IActivityMonitor m, LastWill will )
        {
            throw new NotImplementedException();
        }
        ...
        Task<Task<bool>> IMqttClient.UnsubscribeAsync( IActivityMonitor m, IEnumerable<string> topics )
        {
            throw new NotImplementedException();
        }
    }
