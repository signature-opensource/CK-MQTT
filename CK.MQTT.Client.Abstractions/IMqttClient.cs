...
namespace CK.MQTT
{
    ...
    public interface IMqttClient
    {
        ...
        /// </remarks>
        ValueTask<Task<ConnectResult>> ConnectAsync( IMqttLogger m, IMqttLoggerFactory loggerFactory, MqttClientCredentials? credentials = null, OutgoingLastWill? lastWill = null );
